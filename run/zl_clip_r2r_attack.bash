name=zl_clip_vit_fedavg_new_glr2_epc1_attack
flag="--attn soft --train listener
      ...
      --fed_alg fedavg
      --attack_type 3
      --backdoor_train_rate 0.1
      --scaled_factor 0.5
      --defense_method empty_later
      --global_lr 2
      --n_parties 61
      --no_train True
      --malicious_rate 1
      ...
      --local_epoches 5"
mkdir -p snap/$name
CUDA_VISIBLE_DEVICES=1 python3 r2r_zonglin/adv_train.py $flag --name $name
