    ...
    if not args.if_fed and not args.env_based:
        ...
        for round in range(comm_round):
            ...
            for idx, k in enumerate(party_list_this_round):
                ...
                if args.defense_method == "PBA" and args.return_empty == True:
                    client_decoder_para['l_prompt.global_emb'] = std_prompt_l
                    client_decoder_para['v_prompt.global_emb'] = std_prompt_v
            ...
            if args.defense_method == "mean":
                ...
                benign_idx = multi_krum(flat_w, expected_malicious, multi_k = True)
